        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/80 mb-8 leading-relaxed animate-fade-in" style={{ animationDelay: "0.3s" }}>
              Secalgo vous accompagne dans la sécurisation de vos systèmes d'information. Une approche humaine, accessible et 100% souveraine.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-primary-foreground/80 mb-8">
              Contactez-nous pour un échange personnalisé sur vos besoins en cybersécurité.
            </p>
            <Button variant="hero" size="xl" asChild>
              <Link to="/contact">
                Nous contacter
